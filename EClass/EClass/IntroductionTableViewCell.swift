...
class IntroductionTableViewCell: UITableViewCell {
    ...
    func setLectureInfo(_ lectureName:String, _ location:String, _ attandance:String, _ price:String, _ time:String, _ basicInfo:String, _ attendanceCount:String) {
